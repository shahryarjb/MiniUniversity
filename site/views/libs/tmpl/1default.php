...
<form action="<?php echo JRoute::_('index.php?option=com_miniuniversity'); ?>" method="post" name="adminForm">
<?php echo $this->pagination->getLimitBox(); // namayesh drop-down baraye limit kardan ?>
<?php echo $this->pagination->getPagesLinks(); // namayesh dokmey-next-prev ?>
