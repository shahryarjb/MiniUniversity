...
<p class="bg-success pads"><i class="fa fa-user"></i> <?php echo JText::_('COM_MINIUNIVERSITY_LIB_WELCOME');?> </p>
  ...
  <div class="row">  
    ...
    <a href="<?php echo JRoute::_('index.php?option=com_miniuniversity&view=teachcat&id=' .  str_replace(" ","-",$item->slug) ); ?>">
      <img alt="<?php echo $item->teachcatname; ?>" src="<?php echo htmlspecialchars($item->teachcatpic); ?>" class="img-circle tichcats" />
      </a>
      <h3 class="tichcats">
       <a href="<?php echo JRoute::_('index.php?option=com_miniuniversity&view=teachcat&id=' .  str_replace(" ","-",$item->slug) ); ?>"> <?php echo $item->teachcatname; ?> </a>
      </h3> 
     <a href="<?php echo JRoute::_('index.php?option=com_miniuniversity&view=teachcat&id=' .  str_replace(" ","-",$item->slug) ); ?>"> <button type="button" class="btn btn-danger tichcats">
