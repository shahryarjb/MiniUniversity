 ...
 * @since  0.0.1
 */
class MiniUniversityViewLibresv extends JViewLegacy
{
	protected $form;
	protected $item;
	protected $script;
	...
	protected function addToolBar()
	{
		...
		if ($isNew)
		{
			...
			{
				JToolBarHelper::apply('libresv.apply', 'JTOOLBAR_APPLY');
				JToolBarHelper::save('libresv.save', 'JTOOLBAR_SAVE');
				JToolBarHelper::custom('libresv.save2new', 'save-new.png', 'save-new_f2.png',
				                       'JTOOLBAR_SAVE_AND_NEW', false);
			}
			JToolBarHelper::cancel('libresv.cancel', 'JTOOLBAR_CANCEL');
		}
		else
		{
			...
			if ($this->canDo->get('core.create')) 
			{
				JToolBarHelper::custom('libresv.save2copy', 'save-copy.png', 'save-copy_f2.png',
				                       'JTOOLBAR_SAVE_AS_COPY', false);
			}
			JToolBarHelper::cancel('libresv.cancel', 'JTOOLBAR_CLOSE');
		}
	}
	/**
