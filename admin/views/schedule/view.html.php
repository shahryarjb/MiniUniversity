 ...
 * @since  0.0.1
 */
class MiniUniversityViewSchedule extends JViewLegacy
{
	protected $form;
	protected $item;
	protected $script;
	...
	protected function addToolBar()
	{
		...
		JToolBarHelper::title($isNew ? JText::_('اضافه کردن استاد')
		                             : JText::_('ویرایش استاد'), 'miniuniversity');
		...
		if ($isNew)
		{
			...
			if ($this->canDo->get('core.create')) 
			{
				...
				JToolBarHelper::custom('schedule.save2new', 'save-new.png', 'save-new_f2.png',
		...
		else
		{
			...
			if ($this->canDo->get('core.create')) 
			{
				JToolBarHelper::custom('schedule.save2copy', 'save-copy.png', 'save-copy_f2.png',
