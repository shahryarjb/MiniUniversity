...
<form action="index.php?option=com_miniuniversity&view=warns" method="post" id="adminForm" name="adminForm">
	...
	<table class="table table-striped table-hover">
		...
		<tr>
			...
			<th width="90%">
				<?php echo JHtml::_('searchtools.sort', 'COM_MINIUNIVERSITY_WARN_CONTENT', 'content', $listDirn, $listOrder); ?>
			</th>
			<th width="5%">
				<?php echo JHtml::_('searchtools.sort', 'COM_MINIUNIVERSITY_WARM_KIND', 'kind', $listDirn, $listOrder); ?>
			</th>
			<th width="5%">
			...
			<?php if (!empty($this->items)) : ?>
				...
				?>
					<tr>
						...
						<td align="center">
	                   <?php  echo JHtml::_('jgrid.published', $row->published, $i, 'libs.', true, 'cb'); ?>
						</td>
					</tr>
				<?php endforeach; ?>
			<?php endif; ?>
