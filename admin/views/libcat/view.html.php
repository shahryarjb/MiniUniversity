...
class MiniUniversityViewLibcat extends JViewLegacy
{
	...
	protected function addToolBar()
	{
		...
		if ($isNew)
		{
			...
			{
				JToolBarHelper::apply('libcat.apply', 'JTOOLBAR_APPLY');
				JToolBarHelper::save('libcat.save', 'JTOOLBAR_SAVE');
				JToolBarHelper::custom('libcat.save2new', 'save-new.png', 'save-new_f2.png',
				                       'JTOOLBAR_SAVE_AND_NEW', false);
			}
			JToolBarHelper::cancel('libcat.cancel', 'JTOOLBAR_CANCEL');
		}
		else
		{
			...
			if ($this->canDo->get('core.create')) 
			{
				JToolBarHelper::custom('libcat.save2copy', 'save-copy.png', 'save-copy_f2.png',
				                       'JTOOLBAR_SAVE_AS_COPY', false);
			}
			JToolBarHelper::cancel('libcat.cancel', 'JTOOLBAR_CLOSE');
		}
	}
	/**
