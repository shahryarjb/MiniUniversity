 ...
 * @since  0.0.1
 */
class MiniUniversityViewWarn extends JViewLegacy
{
	protected $form;
	protected $item;
	protected $script;
	...
	protected function addToolBar()
	{
		...
		if ($isNew)
		{
			...
			{
				JToolBarHelper::apply('warn.apply', 'JTOOLBAR_APPLY');
				JToolBarHelper::save('warn.save', 'JTOOLBAR_SAVE');
				JToolBarHelper::custom('warn.save2new', 'save-new.png', 'save-new_f2.png',
				                       'JTOOLBAR_SAVE_AND_NEW', false);
			}
			JToolBarHelper::cancel('warn.cancel', 'JTOOLBAR_CANCEL');
		}
		else
		{
			...
			if ($this->canDo->get('core.create')) 
			{
				JToolBarHelper::custom('warn.save2copy', 'save-copy.png', 'save-copy_f2.png',
				                       'JTOOLBAR_SAVE_AS_COPY', false);
			}
			JToolBarHelper::cancel('warn.cancel', 'JTOOLBAR_CLOSE');
		}
	}
	/**
