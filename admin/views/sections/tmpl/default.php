...
echo "</br>";
?>
<form action="index.php?option=com_miniuniversity&view=sections" method="post" id="adminForm" name="adminForm">
	<div class="row-fluid">
		<div class="span6">
	...
	<table class="table table-striped table-hover">
		...
		<!---- header balaye filde -->
			...
			<th width="20%">
				<?php echo JHtml::_('grid.sort', 'COM_MINIUNIVERSITY_SECTION_NAME', 'section_name', $listDirn, $listOrder); ?>
			</th>
			<th width="10%">
		...
		<tbody>
			<?php if (!empty($this->items)) : ?>
				<?php foreach ($this->items as $i => $row) :
					$link = JRoute::_('index.php?option=com_miniuniversity&task=section.edit&id=' . $row->id);
				?>
					<tr>
