...
?>
<form action="index.php?option=com_helloworld&view=semesters" method="post" id="adminForm" name="adminForm">
	<div class="row-fluid">
		<div class="span6">
		...
		<tbody>
			<?php if (!empty($this->items)) : ?>
				<?php foreach ($this->items as $i => $row) :
					$link = JRoute::_('index.php?option=com_helloworld&task=semester.edit&id=' . $row->id);
				?>
					<tr>
