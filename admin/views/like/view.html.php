 ...
 * @since  0.0.1
 */
class MiniUniversityViewLike extends JViewLegacy
{
	protected $form;
	protected $item;
	protected $script;
	...
	protected function addToolBar()
	{
		...
		if ($isNew)
		{
			...
			if ($this->canDo->get('core.create')) 
			{
				...
				JToolBarHelper::custom('teacher.save2new', 'save-new.png', 'save-new_f2.png',
		...
		else
		{
			...
			if ($this->canDo->get('core.create')) 
			{
				JToolBarHelper::custom('teacher.save2copy', 'save-copy.png', 'save-copy_f2.png',
